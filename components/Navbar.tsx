            ...
            {isVisible ? (
                <div className='w-full block flex-grow items-center'>
                    <div className="text-sm lg:flex-grow">
                        ...
                        <Button className='p-3 m-5 bg-teal-400 justify-center'>
                            <div>
                                <Link to='/car-parts' onClick={clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-teal-200 hover:text-white mr-4'>
                                    Car Parts
                                </Link>
                            </div>
                        ...
                        <Button className='p-3 m-5 bg-teal-400 justify-center'>
                            <div>
                                <Link to='/car-stock' onClick={clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-teal-200 hover:text-white mr-4'>
                                    Car Stock
                                </Link>
                            </div>
                        ...
                        <Button className='p-3 m-5 bg-teal-400 justify-center'>
                            <div>
                                <Link to='/Login' onClick={clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                                text-teal-200 hover:text-white mr-4'>
                                    Login
                                </Link>
                            </div>
                        ...
                        <Button className='p-3 m-5 bg-teal-400 justify-center'>
                            <div>
                                <Link to='/Logout' onClick={clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                                text-teal-200 hover:text-white mr-4'>
                                    Logout
                                </Link>
                            </div>
